...
export const renameAgentSession = (sessionId, title) => invoke("rename_agent_session", { sessionId, title });
...
// ── 任务组 ──
export const cancelAgentTaskGroup = (taskGroupId) => invoke("cancel_agent_task_group", { taskGroupId });
export const retryAgentTaskGroup = (taskGroupId) => invoke("retry_agent_task_group", { taskGroupId });
export const getTaskStatus = (taskGroupId, taskId) => invoke("get_task_status", { taskGroupId, taskId });
