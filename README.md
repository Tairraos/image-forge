...
<p align="center">
  <img alt="version" src="https://img.shields.io/badge/version-1.0.11-9B7BEE?style=flat-square">
...
- 增加底部状态栏下方留白，并降低主工作台面板拖拽分隔条在非 Hover 状态下的视觉强度。
- 重新排版关于弹窗，以居中的品牌图和无边框信息列表展示版本、编译时间与开发者。

### v1.0.9

- 主工作台任务历史、结果预览和提示词区域移除容器边框，底部状态栏背景延伸至窗口左、右和底部边缘。
